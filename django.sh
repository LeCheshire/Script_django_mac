...
read -p "Veuillez entrer le nom du projet Django 'default: projet' : " project_name
...
read -p "Veuillez entrer le nom de l'application Django 'default: app' : " app_name
...
# Install GNU sed (if not already installed)
brew install gnu-sed

# Add the application name to line 40 of the settings.py file
gsed -i "40i\\
    '$app_directory'," "$settings_file"

# Add "bootstrap5" to line 41 of the settings.py file
gsed -i "41i\\
